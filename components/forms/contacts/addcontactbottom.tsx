...
const AddContactBottom = (props: any) => {
  const {
    setIsSelected,
    InputData,
    heading,
  ...
  const SaveInfo = () => {
    setIsSelected(false);
    setjobDescriptionText(textArea);
  };
  const setColorBlue = () => {
    setisRed(false);
    setisGreen(false);
        ...
        <div className="sidebar-bottom-main row bg-light-pink w-100 m-auto">
          ...
          <div className="col-6">
            <div className="d-flex align-items-center justify-content-end h-100 contact-add-cancel">
              ...
              {jobsection ? (
                <button className="btn btn-theme-primary py-2 " onClick={() => SaveInfo()}>
                  {addorsave}{' '}
                </button>
              ) : (
                <button className="btn btn-theme-primary py-2 " onClick={() => setIsSelected()}>
                  {addorsave}{' '}
                </button>
              )}

              {isFullScreen ? (
                <div className="mx-4 cursor-pointer " onClick={() => setFullScreen(!FullScreen)}>
                  <FullScreenIocn />{' '}
                </div>
              ) : (
                ''
        ...
        <div className="add-modal-body ps-3">
          <div className=" row mx-0">
            {InputData.map((val, index) => {
              return (
                <div key={`${index}-ask`} className="col-lg-3 inputStyle col-md-10 col-12 mt-4">
                  <FormInputs
                    key={index}
                    label={val.label}
                    type={val.type}
          ...
          {jobsection ? (
            <div className="description-box ">
              ...
              <div className="description-box-main">
                ...
                <textarea
                 ...
                 ${isRed ? 'font-red' : ''} ${isBlue ? 'text-blue' : ''} ${
                    isGreen ? 'font-green' : ''
                  }`}
                />
              </div>
...
export default AddContactBottom;
