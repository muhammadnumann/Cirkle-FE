      ...
      <div className="sidebar-right-side">
        <div className="row bg-light-pink">
          <div className="col-6">
            ...
            >
              ...
              <span className="ms-3 globle-heading-h4">Add Note</span>
            </div>
          </div>
          <div className="col-6">
            <div className="d-flex align-items-center justify-content-end h-100 contact-add-cancel">
              <button onClick={() => setIsSelected(false)} className="btn btn-white py-2">
                <span>Cancel</span>
              </button>
        ...
        <div className="ps-3 mt-4">
          <div className="form-setting row mx-0">
            <div className="col-md-12 inputStyle">
              <label className={styles.informationlabel} htmlFor="">
                Note
              </label>
              <textarea rows={10} placeholder="Type here" className="form-control"></textarea>
            </div>
          </div>
        </div>
      </div>
