        ...
        <div className="row bg-light-pink">
          <div className="col-6">
            ...
            >
              ...
              <span className="ms-3 globle-heading-h4">{props.title}</span>
            </div>
          </div>
          <div className="col-6">
            <div className="d-flex align-items-center justify-content-end h-100 contact-add-cancel">
              ...
              <button className="globle-gradient-btn border-r-6">Add</button>
            </div>
          </div>
        </div>
        <div className="ps-3">
